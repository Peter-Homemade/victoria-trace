...
| Tests | Check replay rules, evidence output, immutability, correction behavior, and the generated regression. | Domain and regression-execution coverage implemented; CLI presentation pending |
...
revision-5 correction; no CLI or terminal presentation is implemented yet.
